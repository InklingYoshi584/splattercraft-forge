...
public class InkstrikeLandingModel extends EntityModel<InkstrikeLandingIndicatorEntity>
{
    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation(Splatcraft.MODID, "inkstrike_landing_indicator"), "main");
    private final ModelPart bone;
    private final ModelPart bone2;

    public InkstrikeLandingModel(ModelPart root)
    {
